...
import { getProductReviews, deleteReview, clearErrors } from '../../store/actions/product-actions';
...
const ProductReviews = () => {
  ...
  const { error, reviews } = useSelector((state) => state.review);
  ...
  useEffect(() => {
    ...
    if (isDeleted) {
      ...
      dispatch(reviewActions.deleteReviewReset());
    }
