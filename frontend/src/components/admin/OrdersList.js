...
import { allOrders, deleteOrder, clearErrors } from '../../store/actions/order-actions';
...
const OrdersList = ({ history }) => {
  ...
  const { loading, error, orders, isDeleted } = useSelector((state) => state.order);
  ...
  useEffect(() => {
    ...
    if (isDeleted) {
      ...
      dispatch(orderActions.deleteOrderReset());
    }
